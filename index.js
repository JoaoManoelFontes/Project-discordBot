...
const client = new Discord.Client({ intents: [Intents.FLAGS.GUILDS, Intents.FLAGS.GUILD_MESSAGES] }, { //adicionando status no bot
    presence: {
        status: 'online',
        activity: {
            name: 'Toy Story',
...
client.on("message", function(message) {
    ...
    const errorEmbed = new MessageEmbed() //mensagem de erro personalizada
        .setColor('#800000')
        .setTitle('Erro!')
        .setTimestamp()
    ...
    if (command === "sort") { //sorteia qualquer quantidade de números, palavras ou pessoas... 
        ...
        .setColor('#4B0082')
            ...
            .addFields({ name: '!sort', value: 'Sorteia qualquer quantidade de números, palavas, pessoas, etc. Teste: Digite !sort 1 2 3 no chat e um desses items vão ser sorteados' }, { name: '!prob', value: 'Sorteia uma probabilidade de acontecer qualquer sentença. Teste: Digite !prob do Discord ser muito bom e o bot te mostrará a probabilidade ' }, )
            .setTimestamp()
